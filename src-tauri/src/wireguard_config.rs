        ...
        match addr {
            SocketAddr::V4(v4) => {
                ...
                sockaddr.Ipv4.sin_addr = IN_ADDR {
                    ...
                    S_un: IN_ADDR_0 { S_addr: u32::from_ne_bytes(v4.ip().octets()) },
                };
            }
            SocketAddr::V6(v6) => {
...
mod abi_tests {
    ...
    fn test_peer_offsets() {
        ...
        assert_eq!(offset_of!(WireguardPeer, endpoint), 76,  "0x4c — after Reserved2 padding");
